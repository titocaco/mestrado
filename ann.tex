...
\begin{definition}[Função Identidade]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{figs/ann_identity_function.pdf}
...
\begin{definition}[Função Degrau Unitário]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{figs/ann_unit_step_function.pdf}
        \caption{Plot da função de degrau unitário.}
...
\begin{definition}[Função Logística]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{figs/ann_logistic_function.pdf}
