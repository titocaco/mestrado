...
Um equipamento considerado bastante grande para os padrões contemporâneos foi projetado pioneiramente para implementar o que se concebeu como sendo o algoritmo do \textit{perceptron}, tal como pode ser visto pela Figura \ref{fig:ann_perceptron_mark}.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{figs/ann_perceptron_mark.pdf}
    \caption{Primeira implementação em \textit{Hardware} de um \textit{Perceptron}.}
    \label{fig:ann_perceptron_mark}
\end{figure}
