...
\noindent sendo $\eta$ a taxa de aprendizado do algoritmo, que pode ser interpretada como um parâmetro de entrada do algoritmo a ser escolhido pelo projetista da rede, mas que não deve ser vista como se significasse necessariamente que a utilização de uma taxa maior implicaria uma velocidade de aprendizado maior no sentido de reduzir o tempo demandado para se realizar toda a etapa de treinamento da rede, pois essa seria uma concepção equivocada.
