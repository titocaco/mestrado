...
\begin{definition}[Função Degrau Unitário]
    Dada uma entrada $x$ qualquer, a função Degrau Unitário $u[x]$, também chamada de função Degrau Binário, pode ser definida como:
    ...
    A Figura \ref{fig:ann_step_function} exibe o comportamento da função de degrau unitário (ou binário).
