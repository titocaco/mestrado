...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_identity_function.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_unit_step_function.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_logistic_function.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_tanh_function.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_arctan_function.pdf}

    \caption{Plot da função arco tangente.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{figs/ann_relu_function.pdf}

    \caption{Plot da função ReLU.}
