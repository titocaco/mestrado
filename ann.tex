...
\noindent onde $N$ representa o número total de entradas e, portanto, também de seus respectivos pesos para que seja possível efetuar as ponderações; e $b$ representa o \textit{bias}. A partir do resultado do somatório, chega-se à \textit{função de ativação}, a respeito da qual será melhor discutido na seção seguinte.
...
Uma das funções mais simples é a \textit{função identidade}, que permite quaisquer valores de entrada e saída.


\begin{definition}[Função Identidade]
    Dada uma entrada $x$ qualquer, a função Identidade pode ser definida como:
...
A Figura \ref{fig:ann_identity_function} exibe o comportamento da função identidade.

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{figs/ann_identity_function.pdf}
        \caption{Plot da função identidade.}
...
\begin{definition}[Função Degrau Unitário]
    Dada uma entrada $x$ qualquer, a função Degrau Unitário, também chamada de função Degrau Binário, pode ser definida como:
...
A Figura \ref{fig:ann_step_function} exibe o comportamento da função degrau unitário (ou binário).
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{figs/ann_unit_step_function.pdf}
        \caption{Plot da função degrau unitário.}
...
\begin{definition}[Função Logística]
    Dada uma entrada $x$ qualquer, a função Logística pode ser definida como:
...
A Figura \ref{fig:ann_logistic_function} exibe o comportamento da função logística.
    ...
    \begin{figure}[H]
        ...
        \caption{Plot da função logística.}
