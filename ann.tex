...
A Figura \ref{fig:ann_relu_function} exibe o comportamento da função ReLU acompanhado de sua primeira derivada.
...
A Figura \ref{fig:ann_lrelu_function} exibe o comportamento da função LReLU e sua primeira derivada.
...
A Figura \ref{fig:ann_isrlu_function} exibe a função ISRLU junto à sua primeira derivada.
