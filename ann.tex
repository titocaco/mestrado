...
O impacto causado pelas redes neurais artificiais se intensificou drasticamente a partir da criação do Perceptron Multicamada (\textbf{MLP}, \textit{Multi-Layer Perceptron}); já de longa data, os resultados obtidos levavam pesquisadores e desenvolvedores a acreditar que sua estrutura possuía características intrínsecas capazes de amplas capacidades de aproximação de modelos e, embora ainda não tivessem sido matematicamente provadas tais características, sua exploração por parte de diversos pesquisadores resultou em muitos importantes avanços na área. Porém, ao fim da década de 1980 foi publicado o primeiro trabalho que efetuava tal prova matemática em relação a tais características de aproximação \citep{hornik1989multilayer}, embora tivesse sido feito com base em funções sigmoidais.  o que ficou conhecido como Teorema da Aproximação Universal.

\nomenclature{MLP}{\textit{Multi-Layer Perceptron}}
