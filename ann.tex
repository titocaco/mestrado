...
\begin{definition}[Distribuição de Probabilidade Conjunta baseada em Energia]
    Dada a função de partição $Z$, que pode ser definita por:
    ...
    \noindent em que $g_{j}$ representa o grau de degenerescência do auto-estado de energia $E_{j}$; $k_{B}$ é a constante de Boltzmann; e $T$ é a temperatura; pode-se, então, definir a distribuição de probabilidade conjunta com base na energia da seguinte forma:
