...
\definecolor{myblue}{RGB}{0, 119, 179}
...
% \definecolor{citeblue}{rgb}{0.1,0.1,0.4}
\definecolor{midnightgray}{rgb}{0.1, 0.1, 0.1}

\newenvironment{formal}{%
  \def\FrameCommand{%
    \hspace{1pt}%
    {\color{midnightgray}\vrule width 2pt}%
...
\newcommand\chapnumfont{%
  \fontsize{240}{130}\color{myblueii}\selectfont%
}
...
\titleformat{\chapter}
  ...
  \node[
      anchor=north east,
      align=right,
      inner xsep=0pt] at ([yshift=-1.5cm]chapname.east|-chapnum.south)
...
\titlespacing*{\chapter}{0pt}{0pt}{7.0cm}
